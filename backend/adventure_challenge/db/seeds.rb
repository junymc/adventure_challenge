...
Adventure.create(name: "The helpless baker", 
                 ...
                 description: "Make a homemade cookies with your partner! One of you has to mix all the ingredients by youeslef.. BLINDFOLDED, while the other person gives instructions by leading with their hands. The leader only can use three directive sentences the whole time.", 
                 scratch: false)
Adventure.create(name: "Don't be a stranger", 
                 ...
                 time: "Anytime", 
                 duration: "1hr", 
                 description: "Go to park or a mall by yourslef. Just talk to rendom people with friendly conversation. Don't scare them away. I bet you will hear interesting stories. The callenge is if you can get their names and phone nunmers. If you ever get the answer 'no', you lose!",
                 scratch: false)
